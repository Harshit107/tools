...
export const WebsiteDetailsModal: React.FC<WebsiteDetailsModalProps> = ({ website, onClose }) => {
        ...
        {website.username && (
          <DetailsGroup>
            ...
            <ValueContainer>
              ...
              <IconButton onClick={() => handleCopy(website.username!)} title="Copy Username">
                <Copy size={16} />
              </IconButton>
            </ValueContainer>
          </DetailsGroup>
              ...
              {isPasswordVisible && decryptedInfo ? (
                <ValueContainer style={{ borderColor: '#10B981', backgroundColor: '#ECFDF5', color: '#064E3B' }}>
                   ...
                   <div style={{ display: 'flex', gap: '8px' }}>
                     <IconButton onClick={() => handleCopy(decryptedInfo)} title="Copy Password">
                       <Copy size={16} />
                     </IconButton>
                     <IconButton onClick={resetView} title="Hide Password">
                       <EyeOff size={16} />
                     </IconButton>
                   </div>
                </ValueContainer>
